...
export default function CalendarPage() {
  ...
  const projectsForSelectedDate = projects.filter((project) =>
    project.due_date ? isSameDay(new Date(project.due_date), selectedDate || new Date()) : false
  );
    ...
    <AuthLayout>
      <main className="flex flex-col items-center gap-6 w-full max-w-7xl mx-auto px-6 py-10">
        <div className="w-full">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Lab Calendar</h1>
          <p className="text-gray-600 mb-8 max-w-2xl">
            Track important dates for lab projects, protocols, and deadlines. Days with scheduled projects are highlighted.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 w-full">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 w-full md:w-1/2 border border-gray-200">
            ...
            <DayPicker
              ...
              modifiersClassNames={{ highlighted: "bg-blue-100 text-blue-800 font-semibold rounded-full" }}
          ...
          {/* Project List */}
          <div className="bg-white rounded-xl shadow-md p-6 w-full md:w-1/2 border border-gray-200">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Projects on this Day</h2>
            {projectsForSelectedDate.length > 0 ? (
                  ...
                  >
                    ...
                    {project.assignees?.length > 0 && (
                      <p className="text-xs text-gray-500">
                        Assigned: {project.assignees.join(", ")}
                      </p>
                    )}
                  </li>
                ))}
              ...
              <p className="text-sm text-gray-500">No projects scheduled for this day.</p>
            )}
          </div>
        </div>
      </main>
